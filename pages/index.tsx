...
async function sendImage(imageData: File, setImageDetail: any, setAudioUrl: any) {
	if (!imageData) return;
	// compress imageData
			...
			<div className={classes.inner}>
				...
				<div className={classes.wrapperD}>
					...
					<Flex className={classes.controlD} gap={16}>
						<Button size="md" radius="xl" onClick={() => openRef.current?.()} rightIcon={<IconPaperclip />}>
							Зураг сонгох
						</Button>
						<Button
				...
				<Modal opened={opened} onClose={close} title="Сонгогдсон зураг">
					...
					<Button
						onClick={() => {
							sendImage(images?.[0], setImageDetail, setAudioUrl);
						}}
						w={"100%"}
						mt={12}
					>
